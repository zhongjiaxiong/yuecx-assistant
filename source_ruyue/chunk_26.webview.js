...
var cQ8B=_n('indexDh2')
_(r,cQ8B)
var oR8B=_mz(z,'index-float-btn',['isFullPage',0,'pageName',1],[],e,s,gg)
_(r,oR8B)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/index_dh/index_dh.wxss'] = setCssToHead([[2,"./colorui/main.wxss"],"body{background:var(--white)}\n.",[1],"line-box{height:calc(100% - ",[0,20],")}\n.",[1],"border-radius-10{border-radius:",[0,10],"}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/index_dh/index_dh.wxss:1:67858)",{path:"./pages/index_dh/index_dh.wxss"});
}