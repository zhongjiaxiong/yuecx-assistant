...
Z([[7],[3,'screenWidth']])
Z([3,'margin padding'])
Z([3,'margin-36 text-lg text-gray text-center'])
Z([3,'停止服务'])
...
var tQ5B=_mz(z,'banner-notice',['bannerClass',1,'bannerImageClass',1,'bind:onNoticeComLoad',2,'class',3,'firstBannerHeight',4,'noticeClass',5,'screenWidth',6],[],e,s,gg)
_(aP5B,tQ5B)
_(r,aP5B)
var eR5B=_n('view')
_rz(z,eR5B,'class',8,e,s,gg)
var bS5B=_n('view')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/index/indexStop/indexStop.wxss'] = setCssToHead([[2,"./app.wxss"],[2,"./colorui/main.wxss"],[2,"./components/bannerNotice/bannerNotice.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/index/indexStop/indexStop.wxss:1:542)",{path:"./pages/index/indexStop/indexStop.wxss"});
}