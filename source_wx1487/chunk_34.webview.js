...
var cOVB=_n('view')
var oPVB=_mz(z,'web-view',['src',0,'webviewStyles',1],[],e,s,gg)
_(cOVB,oPVB)
_(r,cOVB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/richtext/webView.wxss']=setCssToHead([],undefined,{path:"./pages/richtext/webView.wxss"});
}